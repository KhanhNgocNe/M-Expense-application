...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(am_food == 0 && am_docs == 0 && am_hotel == 0 && am_trans == 0 && am_others == 0)
        {
            ...
            if (am_food != 0) {
                pieData.add(new SliceValue(am_food, Color.parseColor("#8EC1B0")).setLabel("Food"));
            }
            if (am_docs != 0) {
                pieData.add(new SliceValue(am_docs, Color.parseColor("#AEBDCA")).setLabel("Documents"));
            }
            if (am_hotel != 0) {
                pieData.add(new SliceValue(am_hotel, Color.parseColor("#DBC8AC")).setLabel("Hotel"));
            }
            if (am_trans != 0) {
                pieData.add(new SliceValue(am_trans, Color.parseColor("#F6C6AA")).setLabel("Transport"));
            }
            if (am_others != 0) {
                pieData.add(new SliceValue(am_others, Color.parseColor("#D8D3CD")).setLabel("Others"));
            }
